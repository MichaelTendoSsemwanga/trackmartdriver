      ...
      appBar: new AppBar(
        ...
        actions: <Widget>[
          IconButton(
            ...
            onPressed: () async {
              if (await canLaunch('http://sandtrackdriverapp.com/faq')) {
                await launch('http://sandtrackdriverapp.com/faq');
              } else {
                throw 'Could not launch http://www.sandtrackdriverapp.com/faq';
              }
            },
          )
        ],
        ...
        child: Column(children: <Widget>[
          ...
          InkWell(
              child: Row(children: <Widget>[
                Text('What does Trackmart Driver do?',
